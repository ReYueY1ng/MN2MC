...
class PB_ProfessionChangeHC(_message.Message):
    ...
    profession: int
    def __init__(
        self, objid: _Optional[str] = ..., profession: _Optional[int] = ...
    ) -> None: ...
...
class PB_ActorSandwormHC(_message.Message):
    ...
    def __init__(
        self,
        objid: _Optional[int] = ...,
        isshow: _Optional[bool] = ...,
        canmove: _Optional[bool] = ...,
        scale: _Optional[int] = ...,
        objid2: _Optional[int] = ...,
        isfly: _Optional[bool] = ...,
    ) -> None: ...
...
class PB_SkillplayanimHC(_message.Message):
    ...
    def __init__(
        self,
        objid: _Optional[int] = ...,
        tpsanimid: _Optional[int] = ...,
        fpsanimid: _Optional[int] = ...,
        loop: _Optional[int] = ...,
        playLayer: _Optional[int] = ...,
    ) -> None: ...
...
class PB_SkillplaybodyeffectHC(_message.Message):
    ...
    def __init__(
        ...
        OffsetPosition: _Optional[_Iterable[int]] = ...,
        rote: _Optional[_Iterable[int]] = ...,
        scale: _Optional[_Iterable[int]] = ...,
        loop: _Optional[bool] = ...,
        motionclass: _Optional[int] = ...,
    ) -> None: ...
...
class PB_AccumulatorHC(_message.Message):
    ...
    progress: float
    def __init__(
        self, uin: _Optional[int] = ..., progress: _Optional[float] = ...
    ) -> None: ...
...
class PB_SkillsetchargemoveHC(_message.Message):
    ...
    chargemove: float
    def __init__(
        self, uin: _Optional[int] = ..., chargemove: _Optional[float] = ...
    ) -> None: ...
...
class PB_BasestateHC(_message.Message):
    ...
    def __init__(
        self,
        objid: _Optional[int] = ...,
        SetAbilityGroupState: _Optional[int] = ...,
        eGroupID: _Optional[int] = ...,
        bOpen: _Optional[int] = ...,
        SetAbilityState: _Optional[int] = ...,
        eAbilityID: _Optional[int] = ...,
    ) -> None: ...
...
class PB_SetmovementModeHC(_message.Message):
    ...
    def __init__(
        self, objid: _Optional[int] = ..., movementModeOrAuto: _Optional[int] = ...
    ) -> None: ...
...
class PB_PlayerCameraconfigHC(_message.Message):
    ...
    def __init__(
        self,
        obj: _Optional[int] = ...,
        ops: _Optional[_Iterable[int]] = ...,
        posx: _Optional[int] = ...,
        posy: _Optional[int] = ...,
        posz: _Optional[int] = ...,
        fov: _Optional[float] = ...,
        dirx: _Optional[float] = ...,
        diry: _Optional[float] = ...,
        dirz: _Optional[float] = ...,
    ) -> None: ...
...
class PB_BackpackNumChangeHC(_message.Message):
    ...
    num: int
    def __init__(
        self, uin: _Optional[int] = ..., num: _Optional[int] = ...
    ) -> None: ...
...
class PB_NewYearMonsterPosHC(_message.Message):
    ...
    pos: _containers.RepeatedScalarFieldContainer[int]
    def __init__(
        self, objid: _Optional[int] = ..., pos: _Optional[_Iterable[int]] = ...
    ) -> None: ...
...
class PB_PedalBlockCH(_message.Message):
    ...
    def __init__(
        ...
        srcpos: _Optional[_Iterable[int]] = ...,
        despos: _Optional[_Iterable[int]] = ...,
