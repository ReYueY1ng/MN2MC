...
class PB_HeartBeatCH(_message.Message):
    ...
    def __init__(
        self,
        BeatCode: _Optional[int] = ...,
        server_time: _Optional[int] = ...,
        client_time: _Optional[int] = ...,
        aceinfo: _Optional[bytes] = ...,
        Rtt: _Optional[int] = ...,
    ) -> None: ...
...
class PB_SyncChunkDataCH(_message.Message):
    ...
    def __init__(
        self,
        SectionCoord: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        trunkmd5: _Optional[str] = ...,
    ) -> None: ...
...
class PB_RoleEnterWorldCH(_message.Message):
    ...
    def __init__(
        self,
        Uin: _Optional[int] = ...,
        GeniusLv: _Optional[int] = ...,
        UICtrlMode: _Optional[int] = ...,
        RoleInfo: _Optional[_Union[_proto_common_pb2.PB_RoleInfo, _Mapping]] = ...,
        VipInfo: _Optional[_Union[_proto_common_pb2.PB_PlayerVipInfo, _Mapping]] = ...,
        lang: _Optional[int] = ...,
        apiid: _Optional[int] = ...,
        reserved: _Optional[int] = ...,
        Auth: _Optional[str] = ...,
        country: _Optional[str] = ...,
        cltversion: _Optional[int] = ...,
        session_id: _Optional[str] = ...,
        game_session_id: _Optional[str] = ...,
        specify_team: _Optional[int] = ...,
    ) -> None: ...
...
class PB_RoleCheckJoinFromSrcCH(_message.Message):
    ...
    JoinFromSrc: str
    def __init__(
        self, Uin: _Optional[int] = ..., JoinFromSrc: _Optional[str] = ...
    ) -> None: ...
...
class PB_RoleMoveCH(_message.Message):
    ...
    def __init__(
        ...
        AddMotion: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        rentToken: _Optional[int] = ...,
        speed: _Optional[float] = ...,
        VehiclePos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        RayOrigin: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        RayDir: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
    ) -> None: ...
...
class PB_TrainMoveCH(_message.Message):
    ...
    def __init__(
        ...
        MotionX: _Optional[float] = ...,
        MotionY: _Optional[float] = ...,
        MotionZ: _Optional[float] = ...,
...
class PB_GunInfoCH(_message.Message):
    ...
    def __init__(
        self,
        CurSpread: _Optional[float] = ...,
        CurJaw: _Optional[float] = ...,
        CurPitch: _Optional[float] = ...,
        CurPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
    ) -> None: ...
...
class PB_BlockInteractCH(_message.Message):
    ...
    def __init__(
        self,
        face: _Optional[int] = ...,
        colptx: _Optional[int] = ...,
        colpty: _Optional[int] = ...,
        colptz: _Optional[int] = ...,
...
class PB_ItemUseCH(_message.Message):
    ...
    def __init__(
        ...
        shift: _Optional[int] = ...,
        CurSpread: _Optional[float] = ...,
        CurYaw: _Optional[float] = ...,
        CurPitch: _Optional[float] = ...,
        CurPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        usetick: _Optional[int] = ...,
        itemindex: _Optional[int] = ...,
        fireInterval: _Optional[int] = ...,
        PickResultPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        PickResultFace: _Optional[int] = ...,
    ) -> None: ...
...
class PB_ItemSkillUseCH(_message.Message):
    ...
    def __init__(
        ...
        CurSpread: _Optional[float] = ...,
        CurPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        CurDirX: _Optional[float] = ...,
        CurDirY: _Optional[float] = ...,
        CurDirZ: _Optional[float] = ...,
        ClientParam: _Optional[str] = ...,
        itemindex: _Optional[int] = ...,
    ) -> None: ...
...
class PB_ActorInteractCH(_message.Message):
    ...
    def __init__(
        ...
        CurPitch: _Optional[float] = ...,
        CurPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        CollidePos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
    ) -> None: ...
...
class PB_PCMouseEventCH(_message.Message):
    ...
    def __init__(
        self,
        target: _Optional[int] = ...,
        keyType: _Optional[_Union[PCMouseKeyType, str]] = ...,
        eventType: _Optional[_Union[PCMouseEventType, str]] = ...,
    ) -> None: ...
...
class PB_BackPackGridSwapCH(_message.Message):
    ...
    ToGridId: int
    def __init__(
        self, FromGridId: _Optional[int] = ..., ToGridId: _Optional[int] = ...
    ) -> None: ...
...
class PB_BackPackMoveItemCH(_message.Message):
    ...
    def __init__(
        self,
        FromIndex: _Optional[int] = ...,
        ToIndex: _Optional[int] = ...,
        Num: _Optional[int] = ...,
    ) -> None: ...
...
class PB_BackPackGridDiscardCH(_message.Message):
    ...
    Num: int
    def __init__(
        self, GridId: _Optional[int] = ..., Num: _Optional[int] = ...
    ) -> None: ...
...
class PB_SetContainerTextCH(_message.Message):
    ...
    Text: str
    def __init__(
        self, BaseIndex: _Optional[int] = ..., Text: _Optional[str] = ...
    ) -> None: ...
...
class PB_BackPackStoreCH(_message.Message):
    ...
    Num: int
    def __init__(
        self, FromIndex: _Optional[int] = ..., Num: _Optional[int] = ...
    ) -> None: ...
...
class PB_CraftItemCH(_message.Message):
    ...
    Num: int
    def __init__(
        self, CraftId: _Optional[int] = ..., Num: _Optional[int] = ...
    ) -> None: ...
...
class PB_EnchantItemCH(_message.Message):
    ...
    def __init__(
        self,
        GridIndex: _Optional[int] = ...,
        FrmGridIndex: _Optional[int] = ...,
        EnchantIds: _Optional[_Iterable[int]] = ...,
    ) -> None: ...
...
class PB_RuneOperateCH(_message.Message):
    ...
    def __init__(
        ...
        Index1: _Optional[int] = ...,
        Index2: _Optional[int] = ...,
        Index3: _Optional[int] = ...,
        Index4: _Optional[int] = ...,
    ) -> None: ...
...
class PB_RepairItemCH(_message.Message):
    ...
    def __init__(
        self,
        GridIndex: _Optional[int] = ...,
        MaterialID: _Optional[int] = ...,
        UseNum: _Optional[int] = ...,
    ) -> None: ...
...
class PB_GunRecoveryCH(_message.Message):
    ...
    def __init__(
        self,
        bulletID: _Optional[int] = ...,
        shortcut: _Optional[int] = ...,
        curNum: _Optional[int] = ...,
        isCost: _Optional[bool] = ...,
        costNum: _Optional[int] = ...,
    ) -> None: ...
...
class PB_AccountHorseCH(_message.Message):
    ...
    def __init__(
        ...
        CmdType: _Optional[int] = ...,
        CmdData: _Optional[int] = ...,
    ) -> None: ...
...
class PB_ActorReviveCH(_message.Message):
    ...
    Type: int
    def __init__(
        self, ObjID: _Optional[int] = ..., Type: _Optional[int] = ...
    ) -> None: ...
...
class PB_PlayerMountActorCH(_message.Message):
    ...
    def __init__(
        ...
        IsShapeShift: _Optional[bool] = ...,
        InteractBlockId: _Optional[int] = ...,
        IsByNearPlayer: _Optional[bool] = ...,
    ) -> None: ...
...
class PB_PlayerMoveInputCH(_message.Message):
    ...
    def __init__(
        self,
        MoveForward: _Optional[float] = ...,
        MoveStrafing: _Optional[float] = ...,
        Jumping: _Optional[int] = ...,
        Sneaking: _Optional[int] = ...,
        HeroInputUp: _Optional[int] = ...,
    ) -> None: ...
...
class PB_NpcTradeCH(_message.Message):
    ...
    def __init__(
        ...
        OpType: _Optional[int] = ...,
        Index: _Optional[int] = ...,
        WatchAD: _Optional[int] = ...,
        RewardNum: _Optional[int] = ...,
    ) -> None: ...
...
class PB_YMVoiceCH(_message.Message):
    ...
    def __init__(
        ...
        YMSpeakerSwitch: _Optional[int] = ...,
        YMMicSwitch: _Optional[int] = ...,
...
class PB_PlayActCH(_message.Message):
    ...
    ActIDTrigger: int
    def __init__(
        self, ActID: _Optional[int] = ..., ActIDTrigger: _Optional[int] = ...
    ) -> None: ...
...
class PB_SelectMobSpawnerCH(_message.Message):
    ...
    def __init__(
        self,
        Point: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        MobResID: _Optional[int] = ...,
        SpawnCount: _Optional[int] = ...,
        MaxNearbyMobs: _Optional[int] = ...,
        SpawnWide: _Optional[int] = ...,
        SpawnHigh: _Optional[int] = ...,
        MinSpawnDelay: _Optional[int] = ...,
        IsNumberDetection: _Optional[int] = ...,
        IsSpawnDelay: _Optional[int] = ...,
    ) -> None: ...
...
class PB_PackGiftNotifyItemChgCH(_message.Message):
    ...
    def __init__(
        self,
        ShortCutIdx: _Optional[int] = ...,
        CostItemInfo: _Optional[int] = ...,
        addlist: _Optional[_Iterable[int]] = ...,
    ) -> None: ...
...
class PB_PlayerMotionStateChangeCH(_message.Message):
    ...
    StateSwitch: bool
    def __init__(
        self, StateType: _Optional[int] = ..., StateSwitch: _Optional[bool] = ...
    ) -> None: ...
...
class PB_PlayerSelectShortcutCH(_message.Message):
    ...
    index: int
    def __init__(
        self, objid: _Optional[int] = ..., index: _Optional[int] = ...
    ) -> None: ...
...
class PB_ReqDownLoadResUrlCH(_message.Message):
    ...
    ExternData: str
    def __init__(
        self, Type: _Optional[int] = ..., ExternData: _Optional[str] = ...
    ) -> None: ...
...
class PB_CSPlayerPermitCH(_message.Message):
    ...
    def __init__(
        ...
        Uin: _Optional[int] = ...,
        Bit: _Optional[int] = ...,
        BitVal: _Optional[bool] = ...,
        BanItem: _Optional[int] = ...,
        IsBan: _Optional[bool] = ...,
    ) -> None: ...
...
class PB_VehicleWorkshopLineCH(_message.Message):
    ...
    def __init__(
        self,
        ContainerPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        FromPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        ToPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
    ) -> None: ...
...
class PB_CSChangePlayerTeamCH(_message.Message):
    ...
    TeamId: int
    def __init__(
        self, Uin: _Optional[int] = ..., TeamId: _Optional[int] = ...
    ) -> None: ...
...
class PB_MapEditHandleCH(_message.Message):
    __slots__ = (
        ...
        "ExtraParamOffsetY",
        "ExtraParamOffsetZ",
        "ExtraParamRotateAngle",
        "ExtraParamTwoPointCPDir",
        "ExtraParamIsOnlyFillAtmosphere",
        "CenterPos",
        "BeginPos",
        "EndPos",
        "SaveCmd",
    ...
    def __init__(
        self,
        EditMode: _Optional[int] = ...,
        ShapeType: _Optional[int] = ...,
        HandleType: _Optional[int] = ...,
        ExtraParamLength: _Optional[int] = ...,
        ExtraParamWidth: _Optional[int] = ...,
        ExtraParamHeight: _Optional[int] = ...,
        ExtraParamRadius: _Optional[int] = ...,
        ExtraParamIsSolid: _Optional[bool] = ...,
        ExtraParamScale: _Optional[int] = ...,
        ExtraParamIsContinue: _Optional[bool] = ...,
        ExtraParamDir: _Optional[int] = ...,
        ExtraParamFillerId: _Optional[int] = ...,
        ExtraParamReplaceId: _Optional[int] = ...,
        ExtraParamDistance: _Optional[int] = ...,
        ExtraParamOffsetX: _Optional[int] = ...,
        ExtraParamOffsetY: _Optional[int] = ...,
        ExtraParamOffsetZ: _Optional[int] = ...,
        ExtraParamRotateAngle: _Optional[int] = ...,
        ExtraParamTwoPointCPDir: _Optional[int] = ...,
        ExtraParamIsOnlyFillAtmosphere: _Optional[bool] = ...,
        CenterPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        BeginPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        EndPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        SaveCmd: _Optional[int] = ...,
    ) -> None: ...
...
class PB_CSKickOffDataCH(_message.Message):
    ...
    KickerType: int
    def __init__(
        self, Uin: _Optional[int] = ..., KickerType: _Optional[int] = ...
    ) -> None: ...
...
class PB_UsePackingFCMItemCH(_message.Message):
    ...
    def __init__(
        self,
        ItemId: _Optional[int] = ...,
        UsePos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
    ) -> None: ...
...
class PB_CreatePackingCMCH(_message.Message):
    ...
    def __init__(
        self,
        OffsetPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        RotateType: _Optional[int] = ...,
        Name: _Optional[str] = ...,
        Desc: _Optional[str] = ...,
        CreateType: _Optional[int] = ...,
...
class PB_InputContentCH(_message.Message):
    ...
    content: str
    def __init__(
        self, objId: _Optional[int] = ..., content: _Optional[str] = ...
    ) -> None: ...
...
class PB_InputKeyCH(_message.Message):
    ...
    def __init__(
        self,
        objId: _Optional[int] = ...,
        keyType: _Optional[int] = ...,
        eventType: _Optional[str] = ...,
        canClick: _Optional[bool] = ...,
    ) -> None: ...
...
class PB_VillagerModifyName(_message.Message):
    ...
    Name: str
    def __init__(
        self, ObjId: _Optional[int] = ..., Name: _Optional[str] = ...
    ) -> None: ...
...
class PB_CustomModelPrepareCH(_message.Message):
    ...
    HaveFile: int
    def __init__(
        self, Index: _Optional[int] = ..., HaveFile: _Optional[int] = ...
    ) -> None: ...
...
class PB_MoveMobBackpackItemCH(_message.Message):
    ...
    def __init__(
        self,
        gridIndex: _Optional[int] = ...,
        moveType: _Optional[int] = ...,
        toGridIndex: _Optional[int] = ...,
    ) -> None: ...
...
class PB_InteractMobBackpackItemCH(_message.Message):
    ...
    toIndex: int
    def __init__(
        self, fromIndex: _Optional[int] = ..., toIndex: _Optional[int] = ...
    ) -> None: ...
...
class PB_AltarLuckyDrawCH(_message.Message):
    ...
    Pos: _proto_common_pb2.PB_Vector3
    def __init__(
        self, Pos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...
    ) -> None: ...
...
class PB_PlayerDeformationSkinCH(_message.Message):
    ...
    IsShapeShift: bool
    def __init__(
        self, ActorID: _Optional[int] = ..., IsShapeShift: _Optional[bool] = ...
    ) -> None: ...
...
class PB_PlayerBaseAttrCH(_message.Message):
    ...
    def __init__(
        self,
        CurHP: _Optional[float] = ...,
        MaxHP: _Optional[float] = ...,
        CurFoodLv: _Optional[float] = ...,
        MaxFoodLv: _Optional[float] = ...,
        BaseSpeed: _Optional[float] = ...,
        AttackPunch: _Optional[float] = ...,
        AttackRange: _Optional[float] = ...,
        DefensePunch: _Optional[float] = ...,
        DefenseRange: _Optional[float] = ...,
        CurExp: _Optional[int] = ...,
        CurSexp: _Optional[int] = ...,
        CurLevel: _Optional[int] = ...,
        OverflowHP: _Optional[float] = ...,
        CurStrength: _Optional[float] = ...,
...
class PB_PrayTreeTimeCH(_message.Message):
    ...
    stage: int
    def __init__(
        self, uin: _Optional[int] = ..., stage: _Optional[int] = ...
    ) -> None: ...
...
class PB_SUMMONPETCH(_message.Message):
    ...
    def __init__(
        self,
        monsterid: _Optional[int] = ...,
        serverid: _Optional[str] = ...,
        petid: _Optional[int] = ...,
        stage: _Optional[int] = ...,
        quality: _Optional[int] = ...,
        petname: _Optional[str] = ...,
    ) -> None: ...
...
class PB_BackPackRemoveItemItemCH(_message.Message):
    ...
    Num: int
    def __init__(
        self, GridIndex: _Optional[int] = ..., Num: _Optional[int] = ...
    ) -> None: ...
...
class PB_StarStationTransferDeductFeeCH(_message.Message):
    ...
    def __init__(
        ...
        cabinPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        destMapId: _Optional[int] = ...,
        costStar: _Optional[int] = ...,
        transferType: _Optional[int] = ...,
    ) -> None: ...
...
class PB_ExchangeItemsToBackPackCH(_message.Message):
    ...
    def __init__(
        self,
        playerUin: _Optional[int] = ...,
        useItemId: _Optional[int] = ...,
        useItemNum: _Optional[int] = ...,
        gainItemId: _Optional[int] = ...,
        gainItemNum: _Optional[int] = ...,
        opertype: _Optional[int] = ...,
    ) -> None: ...
...
class PB_AddExpCH(_message.Message):
    ...
    starNum: int
    def __init__(
        self, op: _Optional[int] = ..., starNum: _Optional[int] = ...
    ) -> None: ...
...
class PB_UseHearthCH(_message.Message):
    ...
    def __init__(
        self,
        playerUin: _Optional[int] = ...,
        hearthPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        playerPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        isUse: _Optional[bool] = ...,
    ) -> None: ...
...
class PB_AnswerLanternBird_CH(_message.Message):
    ...
    answer: int
    def __init__(
        self, uin: _Optional[int] = ..., answer: _Optional[int] = ...
    ) -> None: ...
...
class PB_UploadCheckInfoCH(_message.Message):
    ...
    detail: bytes
    def __init__(
        self, info_type: _Optional[int] = ..., detail: _Optional[bytes] = ...
    ) -> None: ...
...
class PB_DanceByPlayingCH(_message.Message):
    ...
    playerUin: int
    def __init__(
        self, mobUin: _Optional[int] = ..., playerUin: _Optional[int] = ...
    ) -> None: ...
...
class PB_PvpActivityConfigCH(_message.Message):
    ...
    def __init__(
        self,
        activityId: _Optional[int] = ...,
        reportAddr: _Optional[str] = ...,
        start_time: _Optional[int] = ...,
        end_time: _Optional[int] = ...,
        mapId: _Optional[int] = ...,
        commParam: _Optional[str] = ...,
        timeZone: _Optional[int] = ...,
        extraRule: _Optional[str] = ...,
    ) -> None: ...
...
class PB_StopActCH(_message.Message):
    ...
    actID: int
    def __init__(
        self, playerUin: _Optional[int] = ..., actID: _Optional[int] = ...
    ) -> None: ...
...
class PB_CheatCheatSubJump(_message.Message):
    ...
    def __init__(
        self,
        jumpHeight: _Optional[float] = ...,
        onground: _Optional[bool] = ...,
        airjump: _Optional[bool] = ...,
    ) -> None: ...
...
class PB_CheatCheckSubClip(_message.Message):
    ...
    def __init__(
        ...
        half_height: _Optional[float] = ...,
        bound_height: _Optional[int] = ...,
        bound_size: _Optional[int] = ...,
    ) -> None: ...
...
class PB_HostCheckCheat(_message.Message):
    ...
    def __init__(
        self,
        checkType: _Optional[_Union[CheatCheckType, str]] = ...,
        jump: _Optional[_Union[PB_CheatCheatSubJump, _Mapping]] = ...,
        tackle: _Optional[_Union[PB_CheatCheatSubTackle, _Mapping]] = ...,
        grab: _Optional[_Union[PB_CheatCheatSubGrab, _Mapping]] = ...,
        dribble: _Optional[_Union[PB_CheatCheatSubDribble, _Mapping]] = ...,
        clip: _Optional[_Union[PB_CheatCheckSubClip, _Mapping]] = ...,
    ) -> None: ...
...
class PB_ActorAttackCH(_message.Message):
    ...
    def __init__(
        self,
        objId: _Optional[int] = ...,
        targetIds: _Optional[_Iterable[int]] = ...,
        attackDefName: _Optional[str] = ...,
        triggerAttackHit: _Optional[bool] = ...,
    ) -> None: ...
...
class PB_ActorDefanceStateCH(_message.Message):
    ...
    defanceState: bool
    def __init__(
        self, objId: _Optional[int] = ..., defanceState: _Optional[bool] = ...
    ) -> None: ...
...
class PB_FlagOn(_message.Message):
    ...
    on: bool
    def __init__(
        self, type: _Optional[int] = ..., on: _Optional[bool] = ...
    ) -> None: ...
...
class PB_MoveSyncCH(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[int] = ...,
        move_opera: _Optional[_Union[PB_MoveTick, _Mapping]] = ...,
        pos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        motion: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        flag_change: _Optional[_Iterable[_Union[PB_FlagOn, _Mapping]]] = ...,
        tick: _Optional[int] = ...,
        RayOrigin: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        RayDir: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
    ) -> None: ...
...
class MoveSegmentData(_message.Message):
    ...
    def __init__(
        ...
        deltaTime: _Optional[float] = ...,
        opera: _Optional[int] = ...,
        flagchange: _Optional[int] = ...,
        acceleration: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
        endPos: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
        endMotion: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
...
class PB_ControlMoveV4CH(_message.Message):
    ...
    def __init__(
        self,
        lastServerAckSeq: _Optional[int] = ...,
        moveDataList: _Optional[_Iterable[_Union[MoveSegmentData, _Mapping]]] = ...,
    ) -> None: ...
...
class PB_MoveReconcileFailedLogCH(_message.Message):
    ...
    def __init__(
        self,
        seq: _Optional[int] = ...,
        motion_diff: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        pos_diff: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
    ) -> None: ...
...
class PB_NewRepairItemCH(_message.Message):
    ...
    def __init__(
        self,
        TgtGridIdx: _Optional[int] = ...,
        RepairDur: _Optional[int] = ...,
        mat1Id: _Optional[int] = ...,
        mat2Id: _Optional[int] = ...,
        RepairCount: _Optional[int] = ...,
        StarCount: _Optional[int] = ...,
    ) -> None: ...
...
class PB_GunRayInfo(_message.Message):
    ...
    def __init__(
        ...
        dir: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
        range: _Optional[int] = ...,
        muzzle: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
        effectEnd: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
    ) -> None: ...
...
class PB_ShootData_Actor(_message.Message):
    ...
    def __init__(
        self,
        livingID: _Optional[int] = ...,
        iRay: _Optional[int] = ...,
        hurtParam: _Optional[float] = ...,
    ) -> None: ...
...
class PB_ShootData_Block(_message.Message):
    ...
    def __init__(
        ...
        blockID: _Optional[int] = ...,
        iRay: _Optional[int] = ...,
        blockPosition: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
        blockPoint: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
        faceDirType: _Optional[int] = ...,
    ) -> None: ...
...
class PB_ActorShootCH(_message.Message):
    ...
    def __init__(
        ...
        gunId: _Optional[int] = ...,
        bulletId: _Optional[int] = ...,
        rayInfos: _Optional[_Iterable[_Union[PB_GunRayInfo, _Mapping]]] = ...,
        isAim: _Optional[bool] = ...,
        projectileId: _Optional[int] = ...,
        useTick: _Optional[int] = ...,
        bClientPredict: _Optional[bool] = ...,
        actorDatas: _Optional[_Iterable[_Union[PB_ShootData_Actor, _Mapping]]] = ...,
        blockDatas: _Optional[_Iterable[_Union[PB_ShootData_Block, _Mapping]]] = ...,
    ) -> None: ...
...
class PB_PlayerGunActionCH(_message.Message):
    ...
    action: int
    def __init__(
        self, state: _Optional[bool] = ..., action: _Optional[int] = ...
    ) -> None: ...
...
class PB_ByMountCH(_message.Message):
    ...
    def __init__(
        ...
        boneoffsetpos: _Optional[_Union[_proto_common_pb2.PB_Vector3f, _Mapping]] = ...,
...
class PB_LivingInteractNewCH(_message.Message):
    ...
    def __init__(
        ...
        prepare: _Optional[bool] = ...,
        stepFlags: _Optional[int] = ...,
        failPost: _Optional[bool] = ...,
    ) -> None: ...
...
class PB_PlayerTouchEvtCH(_message.Message):
    ...
    def __init__(
        self,
        targetId: _Optional[int] = ...,
        goNodeType: _Optional[int] = ...,
        targetPos: _Optional[_Union[_proto_common_pb2.PB_Vector3, _Mapping]] = ...,
        mapId: _Optional[int] = ...,
        isMobile: _Optional[bool] = ...,
        touchType: _Optional[_Union[TouchEventType, str]] = ...,
        pcMouseKey: _Optional[_Union[PCMouseKeyType, str]] = ...,
        curToolID: _Optional[int] = ...,
        touchLayer: _Optional[int] = ...,
    ) -> None: ...
...
class PB_WBPMsgCH(_message.Message):
    ...
    def __init__(
        self,
        msgid: _Optional[int] = ...,
        createBPMsg: _Optional[
            _Union[_proto_common_pb2.PB_WBPCreateBluePrintMsg, _Mapping]
        ] = ...,
        clickMsg: _Optional[
            _Union[_proto_common_pb2.PB_WBPClickResultGrid, _Mapping]
        ] = ...,
        addMtlMsg: _Optional[_Union[_proto_common_pb2.PB_WBPAddMtlMsg, _Mapping]] = ...,
        autoplacemsg: _Optional[
            _Union[_proto_common_pb2.PB_WBPAutoPlaceMsg, _Mapping]
        ] = ...,
    ) -> None: ...
...
class PB_ActorPlayAnimFinishCH(_message.Message):
    ...
    msgtype: int
    def __init__(
        self, animid: _Optional[int] = ..., msgtype: _Optional[int] = ...
    ) -> None: ...
